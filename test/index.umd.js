...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.VueTrackPlush = factory());
  ...
  var Service = function () {
      ...
      _createClass(Service, [{
          ...
          value: function initRequest() {
              ...
              // )
              // 执行实例
              service(this.requestConfig).then(function (res) {
                  console.log(res);
          ...
          value: function handleClickEvent(entry) {
              ...
              entry.el.addEventListener('click', function () {
                  _this.track({
                      ...
                      userAgent: _this.trackPlushConfig.userAgent || navigator.userAgent, //客户端设备
                      pageUrl: _this.trackPlushConfig.pageUrl || window.location.href, //当前页面路径
                      projectName: _this.trackPlushConfig.projectName, //项目名称
                      actionType: '点击事件'
                  });
              });
          }
  ...
  var install = function install(Vue, trackPlushConfig) {
      Vue.directive('track', {
